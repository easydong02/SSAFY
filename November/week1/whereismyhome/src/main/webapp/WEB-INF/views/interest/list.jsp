<%@page import="com.ssafy.member.model.Member"%>
<%@page import="com.ssafy.util.SizeConstant"%>
<%@page import="com.ssafy.interest.model.dao.InterestDao"%>
<%@page import="com.ssafy.interest.model.dao.InterestDaoImpl"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"	pageEncoding="UTF-8"%>
<%@ include file="/common/header.jsp"%>

<%
	InterestDao idao = InterestDaoImpl.getInterestDao();
