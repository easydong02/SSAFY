...
<html lang="ko">
  ...
  <body>
          ...
          <form id="form-login" method="POST" action="">
           <!--  <div class="form-check mb-3 float-end">
            ...
            <div class="col-auto text-center">
              ...
              <button type="button" id="btn-mv-findPwd" class="btn btn-outline-warning mb-3">
                비밀번호 찾기
              </button>
            </div>
          </form>
    ...
    document.querySelector("#btn-mv-join").addEventListener("click", function () {
    	location.href = "${root}/member?command=goRegist";
      });
    document.querySelector("#btn-mv-findPwd").addEventListener("click", function () {
    	location.href = "${root}/member?command=goFindPwd";
      });
