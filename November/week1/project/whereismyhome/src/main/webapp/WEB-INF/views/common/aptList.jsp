...
<!-- 중앙 content start -->
    <div class="container">
      ...
      <div style="float: left;  width:50%;" id ="homesImg"  >
      	<img src="${root}/assets/img/homes.jpg"/>
      </div>
	...
	<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=014457ed3fb8a37eda241f4e7dc80c57&libraries=services"></script>
	
	<script src="${root}/assets/js/aptList.js"></script>
