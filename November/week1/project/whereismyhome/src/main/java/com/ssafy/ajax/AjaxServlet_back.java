...
import com.ssafy.subway.model.service.SubwayServiceImpl;

@WebServlet("/ajax2")
public class AjaxServlet_back extends HttpServlet {
	...
	@Autowired
	public AjaxServlet_back(IDongService dservice, IHouseDealService hdservice, ISubwayService subservice) {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case "searchHouseDealInfo":
			...
			break;
		case "searchSubway":
			dosearchSubway(request,response);
			break;
		}
	}
	private void dosearchSubway(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		String result = "";
		try {
			result = gson.toJson(subservice.getSubway(sido));
