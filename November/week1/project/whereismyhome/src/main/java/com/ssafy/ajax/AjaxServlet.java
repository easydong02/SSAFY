...
public class AjaxServlet{
	...
	@Autowired
	public AjaxServlet(IDongService dservice, IHouseDealService hdservice, ISubwayService subservice) {
	...
	private ResponseEntity<?> dosearchSubway(@RequestBody HashMap<String, String> map) throws IOException {
	...
	@PostMapping("/searchHouseDealInfo")
	private ResponseEntity<?> dosearchHouseDealInfo(@RequestBody HashMap<String, String> map) throws IOException {
	...
	private ResponseEntity<?> doGetGugunNames(@RequestBody HashMap<String, String> map) throws IOException {
	...
	private ResponseEntity<?> doGetDongNames(@RequestBody HashMap<String, String> map) throws IOException {
		String sidoName = map.get("sidoName"); 
