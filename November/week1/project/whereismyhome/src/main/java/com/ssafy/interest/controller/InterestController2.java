...
public class InterestController2 extends HttpServlet {
	...
	@Autowired
	public InterestController2(InterestService interestService, IDongService dongService, IHouseDealService hdservice) {
